...
const MarkingsScript = preload(
	"res://scenes/world/generator/chunk_builder_markings.gd"
)
...
func test_init_stores_marking_material() -> void:
	assert_eq(
		_builder._marking_mat, _marking_mat,
...
func test_markings_has_material_override() -> void:
	...
	var inst := chunk.get_child(0) as MeshInstance3D
	assert_eq(
		inst.material_override, _marking_mat,
...
func test_dash_length_positive() -> void:
	assert_gt(
		MarkingsScript.DASH_LENGTH, 0.0,
...
func test_marking_width_positive() -> void:
	assert_gt(
		MarkingsScript.MARKING_WIDTH, 0.0,
...
func test_crossing_bar_dimensions_positive() -> void:
	assert_gt(
		MarkingsScript.CROSSING_BAR_WIDTH, 0.0,
		"Crossing bar width should be positive",
	)
	assert_gt(
		MarkingsScript.CROSSING_BAR_LENGTH, 0.0,
...
func test_crossing_setback_positive() -> void:
	assert_gt(
		MarkingsScript.CROSSING_SETBACK, 0.0,
