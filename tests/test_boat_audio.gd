...
const BoatAudioScript = preload("res://scenes/vehicles/boat_audio.gd")
var _src: String


func before_all() -> void:
	_src = (BoatAudioScript as GDScript).source_code
...
func test_sample_rate_is_22050() -> void:
	assert_eq(BoatAudioScript.SAMPLE_RATE, 22050.0)


func test_base_freq_min_is_35() -> void:
	assert_eq(BoatAudioScript.BASE_FREQ_MIN, 35.0)


func test_base_freq_max_is_140() -> void:
	assert_eq(BoatAudioScript.BASE_FREQ_MAX, 140.0)


func test_idle_burble_freq_is_2() -> void:
	assert_eq(BoatAudioScript.IDLE_BURBLE_FREQ, 2.0)


func test_idle_burble_depth_is_8() -> void:
	assert_eq(BoatAudioScript.IDLE_BURBLE_DEPTH, 8.0)


func test_cull_distance_is_60() -> void:
	assert_eq(BoatAudioScript.CULL_DISTANCE, 60.0)


func test_h2_amp_is_050() -> void:
	assert_eq(BoatAudioScript.H2_AMP, 0.50)


func test_h3_amp_is_015() -> void:
	assert_eq(BoatAudioScript.H3_AMP, 0.15)


func test_h4_amp_is_006() -> void:
	assert_eq(BoatAudioScript.H4_AMP, 0.06)


func test_sub_amp_is_025() -> void:
	assert_eq(BoatAudioScript.SUB_AMP, 0.25)
...
func test_ready_sets_sfx_bus() -> void:
	assert_eq(BoatAudioScript.BUS_NAME, "SFX")


func test_ready_sets_max_distance_80() -> void:
	assert_eq(BoatAudioScript.MAX_DISTANCE, 80.0)
...
func test_ready_sets_buffer_length() -> void:
	assert_eq(BoatAudioScript.BUFFER_LENGTH, 0.1)
...
func test_speed_ratio_clamped_to_80_kmh() -> void:
	assert_eq(BoatAudioScript.SPEED_NORMALIZATION, 80.0)


func test_idle_burble_below_5_kmh() -> void:
	assert_eq(BoatAudioScript.IDLE_SPEED_THRESHOLD, 5.0)


func test_hull_slap_above_15_kmh() -> void:
	assert_eq(BoatAudioScript.BURBLE_SPEED_MIN, 15.0)
...
func test_smooth_volume_transition() -> void:
	assert_eq(BoatAudioScript.VOLUME_SMOOTH_RATE, 6.0)
...
func test_initial_smooth_volume_is_012() -> void:
	assert_eq(BoatAudioScript.SMOOTH_VOLUME_INIT, 0.12)


func test_hull_slap_clamped() -> void:
	assert_eq(BoatAudioScript.BURBLE_SPEED_RANGE, 40.0)
	assert_eq(BoatAudioScript.BURBLE_AMP_MAX, 0.15)
