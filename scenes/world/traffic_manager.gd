...
# Upward velocity that indicates a spring-launch rather than normal driving.
# Ramps/hills peak around 2 m/s; a GEVP impulse launch is typically 20-100 m/s.
...
func _process(delta: float) -> void:
	...
	# Per-frame launch detection: cull vehicles being thrown upward by a
	# bad spawn impulse within a couple of physics frames.
