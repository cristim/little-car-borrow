...
var wheel_array : Array = []
var axles : Array[Axle] = []
var front_axle : Axle
var rear_axle : Axle
var drive_wheels : Array = []
...
func initialize():
	...
	var rear_track_width: float = rear_right_wheel.position.x - rear_left_wheel.position.x
